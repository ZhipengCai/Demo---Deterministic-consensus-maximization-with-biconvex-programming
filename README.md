...
If you want to use some of the included methods to solve your own robust fitting problem, some personal suggestions are provided at the end of the method list :)
