%improved frank-wolfe algorithm for parametric formulation
% A, b: input data
% x0, y0: starting point
% lpsolver: either 'linprog' or 'gurobi'

function [xn, yn, theta, currF] = fwPR_improved(A, b, x0, y0, delta, lpsolver)
