function [theta, arrInls, arrRuntime] = IBCOv2Worse(A,b,c,d,theta0,th,config,problem)
if nargin < 8
    problem = 'general';
end
...
%initialize sedumi model for constrains in socp problem for sx (only need to reset model.obj in BCO_l2 function)
